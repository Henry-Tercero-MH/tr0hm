import '../styles.css';
// Import Bootstrap CSS from node_modules (installed as dependency)
          ...
          {showMobileMenu && (
            <div className="mobile-menu-container">
              <div className="theme-menu mobile-menu" ref={mobileMenuRef} role="menu" aria-label="Menu principal">
                ...
                <Link href="/requests" className="mobile-item" onClick={() => setShowMobileMenu(false)}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden>
                    <path d="M18 8A6 6 0 1 0 6 8c0 7-3 9-3 9h18s-3-2-3-9" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round" />
      ...
      <NotificationsProvider>
        <ToastProvider>
          <Head>
            ...
            {/* Bootstrap loaded from node_modules via import at top of this file */}
          </Head>
          <Header />
          <Component {...pageProps} />
        </ToastProvider>
